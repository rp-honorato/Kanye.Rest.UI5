			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kanyerest-display": {
								"semanticObject": "kanyerest",
								"action": "display",
								"description": "A simple Kanye quotes app made in UI5",
								"title": "Kanye Quotes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kanye.rest",
									"url": sap.ui.require.toUrl("kanye/rest")
								}
							}
						}
					}
